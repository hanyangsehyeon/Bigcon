...
[
    ...
    "content": [
        {
            ...
            "text": "'최종 등급'과 '위험지수백분위'를 중심으로 가게의 현재 상태를 의사처럼 진단하고 요약합니다. 긍정적인 부분과 개선이 시급한 부분을 명확히 언급해주세요. 가게가 속한 상권의 전반적인 건강 상태와 비교하여 우리 가게의 상대적인 위치도 함께 설명합니다.",
        },
    ],
    "basis": "검색된 가맹점의 지정된 컬럼과 값을 세로형 테이블로 표시합니다. 각 항목을 행으로 나누어 표시하여 가독성을 높입니다. \\n\\n| 항목 | 값 |\\n|---|---|\\n| 최종 등급 | [값] |\\n| 위험지수백분위 (상위) | [값]% |\\n| 매출금액 구간 | [값] |\\n| 매출건수 구간 | [값] |\\n| 유니크 고객 수 구간 | [값] |\\n| 객단가 구간 | [값] |\\n| 취소율 구간 | [값] |\\n| 배달매출 비율 | [값] |\\n| 동일 업종 대비 매출금액 비율 | [값] |\\n| 동일 업종 대비 매출건수 비율 | [값] |\\n| 동일 업종 내 매출 순위 비율 | [값] |\\n| 동일 상권 내 매출 순위 비율 | [값] |\\n| 동일 업종 내 해지 가맹점 비중 | [값] |\\n| 동일 상권 내 해지 가맹점 비중 | [값] |"
  },
  {
    ...
    "content": [
        {
            "title": "1. [데이터 기반 처방명 1]",
            "subscription: "위의 '종합 건강 진단' 결과에 따라, 가장 시급하거나 효과적인 해결책을 구체적으로 제시합니다. 마케팅 전략과 함께 적절한 마케팅 문구나 채널을 추천하세요.",
            "subbasis": "해당 처방을 뒷받침하는 데이터와 이것이 뜻하는 의미와 함께 근거를 제시합니다."
        },
        {
            "title": "2. [데이터 기반 처방명 2]",
            "subscription: "두 번째 맞춤 해결책을 구체적으로 제시합니다. 마케팅 전략과 함께 적절한 마케팅 문구나 채널을 추천하세요."
            "subbasis": "해당 처방을 뒷받침하는 데이터와 근거를 제시합니다.",
        },
        {
            "title": "3. [데이터 기반 처방명 3]",
            "subscription: "세 번째 맞춤 해결책을 구체적으로 제시합니다. 마케팅 전략과 함께 적절한 마케팅 문구나 채널을 추천하세요."
            "subbasis": "해당 처방을 뒷받침하는 데이터와 근거를 제시합니다."
        },
    ],
...
st.set_page_config(page_title="우리가게 주치의, Dr. 신한", layout="centered")
